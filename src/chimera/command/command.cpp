...
namespace Chimera {
    ...
    void Chimera::get_all_commands() noexcept {
        ...
        ADD_COMMAND("chimera_show_imgui_demo", "chimera_category_debug", "client", show_imgui_demo_command, false, 0, 0);
        ADD_COMMAND("chimera_show_implot_demo", "chimera_category_debug", "client", show_implot_demo_command, false, 0, 0);
